            ...
            <div class="modal-body">
                <form id="form-edit-article" class="form-article" name="editarticle" method="post" action="api/article/update.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="edit-article" name="article" placeholder="Artikel" title="Artikel" required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form id="form-new-article" class="form-article" name="newarticle" method="POST" action="api/article/create.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="new-article-barcode" name="barcode" placeholder="Stregkode" title="Kategori"
                                   readonly>
                        </div>
                    </div>
                    <div class="form-group">
