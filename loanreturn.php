...
<head>
    <meta charset="UTF-8">
    <title>Udlån/Returnering - Dimselab</title>
...
<div class="container content">
    ...
    <div class="row">
        <div class="col-lg-6">
            <a href="./udlån" role="button" class="btn btn-secondary btn-lg d-block">Udlån</a></div>
        <div class="col-lg-6">
            <a href="./returnering" role="button" class="btn btn-secondary btn-lg d-block">Returnering</a></div>
